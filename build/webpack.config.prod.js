...
const config = {
    // 模式配置
    mode: 'production', // 开发环境：功能调试和优化开发体验,设置为 development 可以解决 WARNING in entrypoint size limit: The following entrypoint(s) combined asset size exceeds the recommended limit (244 KiB)
    // 入口文件
    entry: {
        index: './src/main.js'
    },
